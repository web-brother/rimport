...
function js_files() {
	...
	wp_enqueue_script('contact_validator_js', get_template_directory_uri() . '/vendors/contact-form/validator.js', array('jquery'), '', true);
	wp_enqueue_script('contact_js', get_template_directory_uri() . '/vendors/contact-form/contact.js', array('jquery'), '', true);
}
