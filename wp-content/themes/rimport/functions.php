...
function style_files() {
	...
	wp_enqueue_style('owl_carousel', get_template_directory_uri() . '/vendors/owl-carousel/owl.carousel.css');
	wp_enqueue_style('owl_carousel_theme', get_template_directory_uri() . '/vendors/owl-carousel/owl.theme.css');
}
