	...
	<div>
		<div class="container body-copy">
			<div class="body-copy-header centered light no-margin">
				<h1 class="no-margin-top">Power Generator</h1>
			</div>
		</div>
	</div>
</div>
        ...
        <div class="panel panel-primary">
          ...
          <div class="panel-body">
            <ul>
   				...
   				<li><a href="<?php bloginfo('template_directory'); ?>/resources/docs/power-generator/Genset Quote 6 x 125kva Genset R1.pdf" target="_blank">Genset Quote 6 x 125kva Genset R1.pdf</a></li>
            	</ul>
          </div>
        </div>
      </div>
